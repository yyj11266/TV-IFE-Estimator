...
- `outputs/paper_empirical_feature_diagnostics.csv`
...
- `outputs/predictive_tv_ife_coefficients.csv`
- `outputs/predictive_tv_ife_factors.csv`
- `outputs/predictive_tv_ife_loadings.csv`
- `outputs/predictive_tv_ife_ic.csv`
- `outputs/predictive_tv_ife_fitted.csv`
- `outputs/predictive_tv_ife_fit_summary.csv`
